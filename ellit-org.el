...
;;
;; #+BEGIN_QUOTE
;; This file is automatically generated from {{{elfile(verbatim)}}} by
...
(defvar ellit-org-macro-templates
  '(
    ...
    ("ellit" . "(eval (ellit-org-template-as-is $1))")
    ...
    ("elfile" . "(eval (ellit-org-template-elfile $1))")
...
(defun ellit-org-file (el-file &optional output-org-file template-alist)
...
(defun ellit-org-template-elfile (&optional verbatim)
